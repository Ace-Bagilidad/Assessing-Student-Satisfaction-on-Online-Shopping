...
ageShoppingFreq_plot <- 
  ggplot(demographics, aes(x = age, fill = online_shopping_freq)) +
...
age_bins <- c(14, 18, 24, 30)

# Create age groups
demographics$age_group <- cut(demographics$age, breaks = age_bins, labels = c("14-18", "19-24", "25-30"))

# Bar plot for online shopping frequency by age group
ggplot(demographics, aes(x = age_group, fill = online_shopping_frequency)) +
  geom_bar(position = "fill") +
  labs(title = "Online Shopping Frequency by Age Group",
       x = "Age Group",
       y = "Proportion",
